...
![](https://velog.velcdn.com/images%2Fhaero_kim%2Fpost%2F2981356e-33f1-4d13-8611-9cd6252c3618%2F%E1%84%89%E1%85%B3%E1%86%AF%E1%84%85%E1%85%A1%E1%84%8B%E1%85%B5%E1%84%83%E1%85%B31.png)
...
![](https://techblog.woowahan.com/wp-content/uploads/2023/12/3.png)
...
1:1 대응 모델에서는 스레드가 사용하는 **핵심 리소스**와 **수명 주기**를 OS가 책임집니다.
...
![](https://techblog.woowahan.com/wp-content/uploads/2023/12/4.png)
...
- 스레드 각각의 **실행 상태**를 저장합니다 (지역 변수, 메서드 호출 프레임 등).
...
![](https://velog.velcdn.com/images/lejent3/post/21f29159-336c-4f24-a8ef-31423af2eb11/image.png)

### 가상 스레드란?

가상 스레드는 JDK 21버전에 나온 최신 기술이다. 기존 Java의 스레드 모델과 달리, 플랫폼 스레드와 가상 스레드로 나뉜다. 플랫폼 스레드 위에서 여러 가상 스레드가 번갈아 가며 실행되는 형태로 동작한다.

![](https://techblog.woowahan.com/wp-content/uploads/2023/12/5.png)

우선 플랫폼 스레드의 기본 스케줄러는 ForkJoinPool을 사용하는데, **스케줄러는 플랫폼 스레드 풀을 관리하고, 가상 스레드의 작업 분배 역할**을 한다.

![](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdna%2Fcbu4F4%2FbtsI8hiTZeX%2FAAAAAAAAAAAAAAAAAAAAAJ1InzBuah8Vh8Q4kX1PqOF5Xwwr-aQixSlGubnoFbLn%2Fimg.png%3Fcredential%3DyqXZFxpELC7KVnFOS48ylbz2pIh7yKj8%26expires%3D1761922799%26allow_ip%3D%26allow_referer%3D%26signature%3Dl7JfObT1j%252Bc4Puu9nbIq0q4LFDI%253D)
...
> Kotlin은 _스택 프레임_을 사용하여 로컬 변수와 함께 실행 중인 함수를 관리합니다. 코루틴을 정지하면 현재 스택 프레임이 복사되고 저장됩니다. 재개되면 스택 프레임이 저장된 위치에서 다시 복사되고 함수가 다시 실행됩니다. 코드가 일반적인 순차 차단 요청처럼 보일 수도 있지만 코루틴은 네트워크 요청이 기본 스레드를 차단하지 않도록 합니다.
...
![](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdna%2FnqN8N%2FbtsI6gsuYkQ%2FAAAAAAAAAAAAAAAAAAAAALoU0DtqvZjw0Ky8S9AWjXQEULjOXxyqP--XxjSKUUXw%2Fimg.png%3Fcredential%3DyqXZFxpELC7KVnFOS48ylbz2pIh7yKj8%26expires%3D1761922799%26allow_ip%3D%26allow_referer%3D%26signature%3DXjMBF8XroYZPLQimT%252FrOHgkeCT4%253D)
...
![](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdna%2Fcg0seR%2FbtsI5yf5C8H%2FAAAAAAAAAAAAAAAAAAAAAHql6lLCQPAvAtgHo8w4Oslx-wPxDNj4CKnsnW4MKnfA%2Fimg.png%3Fcredential%3DyqXZFxpELC7KVnFOS48ylbz2pIh7yKj8%26expires%3D1761922799%26allow_ip%3D%26allow_referer%3D%26signature%3DDNIyLs%252FkTl2EfADVOBs2hiZWjog%253D)

![](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdna%2FdQmj9X%2FbtsI7oweHMD%2FAAAAAAAAAAAAAAAAAAAAAKVCoodCfVDx07EVV4RGtkEGbcIvyWXePI3Auq92eiUR%2Fimg.png%3Fcredential%3DyqXZFxpELC7KVnFOS48ylbz2pIh7yKj8%26expires%3D1761922799%26allow_ip%3D%26allow_referer%3D%26signature%3DuATJzQROt9Y8pEDnbxDB3YucXrU%253D)
...
![](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdna%2FmxrG3%2FbtsI7IH2nzU%2FAAAAAAAAAAAAAAAAAAAAAP0MQlL_P7Dzsloo8oRn76Qcv4JsvgZ9UqsrHQhCrpzu%2Fimg.png%3Fcredential%3DyqXZFxpELC7KVnFOS48ylbz2pIh7yKj8%26expires%3D1761922799%26allow_ip%3D%26allow_referer%3D%26signature%3DVgRhKY0hhm8l8EL7nRFn6QxD4%252F0%253D)

`cont.run()` 을 하게 되면, Runnable 내부의 로직들이 Stack에 쌓이게 된다.

![](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdna%2FuVURM%2FbtsI5u5RddY%2FAAAAAAAAAAAAAAAAAAAAAJh71p0ZihosXNjCQ7cMjzh7VKp1mYF47ho3lp8fKq7m%2Fimg.png%3Fcredential%3DyqXZFxpELC7KVnFOS48ylbz2pIh7yKj8%26expires%3D1761922799%26allow_ip%3D%26allow_referer%3D%26signature%3DRYOQ8ELyv2Jbiu%252BAW0kKeq%252BEA88%253D)

그러다가 `cont.yield()` 가 호출되게 되면 `cont.run()` 이후 Stack 을 cont 가 가지고 Heap 메모리 영역으로 이동하게 된다.

![](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdna%2FbcddpG%2FbtsI7s6mszI%2FAAAAAAAAAAAAAAAAAAAAAHxWVLDCYoo_fxUTshdz4Q13FWM-9fz3-rKIiXoAJuH4%2Fimg.png%3Fcredential%3DyqXZFxpELC7KVnFOS48ylbz2pIh7yKj8%26expires%3D1761922799%26allow_ip%3D%26allow_referer%3D%26signature%3DkgQpLB784kSoMweJoeFgxedv32I%253D)
...
- 이 풀의 크기는 일반적으로 **CPU 코어 수**와 비슷하게 설정됩니다. (예: 8코어 시스템이면 Carrier Thread도 8개 내외)
...
1. **부하 균형 유지:** 작업 훔치기 덕분에 특정 스레드에 작업이 집중되는 **부하 불균형(Load Imbalance)** 현상이 해소됩니다. 모든 CPU 코어가 끊임없이 작업을 처리하게 되어 자원 활용률이 극대화된다.
